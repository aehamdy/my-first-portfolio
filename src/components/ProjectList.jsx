...
function ProjectList() {
  ...
  return (
    <div
      // className={`relative grid grid-cols-1 ${filteredProjects.length >= 1 && "sm:grid-cols-2"} gap-6 sm:gap-8 p-section-padding before:absolute before:hidden`}
      className={`relative grid grid-cols-1 ${projectsList.length >= 1 && "sm:grid-cols-2"} gap-6 sm:gap-8 p-section-padding before:absolute before:hidden`}
    >
